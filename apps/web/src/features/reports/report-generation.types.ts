...
export type ReportSettingsModelConfig = components['schemas']['ReportSettingsModelConfig']
export type ReportSettingsUpdateResult =
  components['schemas']['ReportSettingsUpdateResponse']['data']
export type UpdateReportSettingsRequest = components['schemas']['UpdateReportSettingsRequest']
